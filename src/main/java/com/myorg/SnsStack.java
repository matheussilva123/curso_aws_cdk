...
public class SnsStack extends Stack {
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        productEventsTopic = SnsTopic.Builder.create(Topic.Builder.create(this, "ProcutEventsTopic")
                .topicName("product-events")
                .build())
                .build();

        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("paaclee.7@gmail.com")
                .json(true)
                .build());
